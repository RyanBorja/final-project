...
@component('layouts.card')
    @slot('cardHeader')
        <h2 class="text-center" style="font-style: italic;">The aftermath of <br><strong>Quality</strong> <br>lasts longer than<br> the impulsive urge of <br><strong>Price</strong></h2>
    @endslot
    @slot('cardBody')
        <h5 class="card-title text-center"><a href="{{ url('/about') }}">Who we are</a></h5>
        <p class="card-text text-muted text-center">“Our mission is to turn your design needs into a reality”</p>
        <p class="card-text">Allow us to expertly aid you in your kitchen, bathroom, and bar renovation needs.  Our excellent customer service, fabrication expertise, and gorgeous selection of stone materials combine to guarantee your satisfaction.</p>
    @endslot
    @slot('cardImg')
        <img class="card-img-bottom" src="{{ asset('pictures/jumbotronimg.jpeg') }}" alt="Card image kitchen">
    @endslot
@endcomponent
...
@component('layouts.card')
    @slot('cardHeader')
        ...
        <p> pic of jen needed here</p>
    @endslot
    @slot('cardBody')
        <p class="card-text">Call us today to begin your design journey. Our expert style consultant will ensure that your exact fabrication dreams are executed to your satisfaction. Come to our shop to see our comprehensive and beautiful selection of high quality stone, or allow us to perform an in home consultation to ensure your specific needs are met with an expert eye.</p> 
    @endslot
    @slot('cardImg')
        <img class="card-img-bottom" src="{{ asset('pictures/kitchen2.jpeg') }}" alt="Card image kitchen">
    @endslot
@endcomponent             
    ...
    <div class="row">
        ...
        <div class="row align-items-center col-6">
            ...
            <div class="tab-pane fade show active" id="list-home" role="tabpanel" aria-labelledby="list-home-list">
                <img class="card-img-bottom" src="{{ asset('pictures/Alga_Green.jpg') }}" alt="Card image Alga Green">
            </div>
            <div class="tab-pane fade" id="list-profile" role="tabpanel" aria-labelledby="list-profile-list">
                <img class="card-img-bottom" src="{{ asset('pictures/blackgalaxy.jpg') }}" alt="Card image Black Galaxy">
            </div>
            <div class="tab-pane fade" id="list-messages" role="tabpanel" aria-labelledby="list-messages-list">
                <img class="card-img-bottom" src="{{ asset('pictures/stone1.jpg') }}" alt="Card image Green Power Ranger">
            </div>
            <div class="tab-pane fade" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list">
                <img class="card-img-bottom" src="{{ asset('pictures/typhoongold.jpg') }}" alt="Card image Typhoon Gold">
            </div>
            </div>
        </div>
    </div>
            ...
            <div id="carouselLeandingPageIndicators" class="carousel slide carousel-fade" data-ride="carousel">
                ...
                <div class="carousel-inner mx-auto">
                    <div class="carousel-item active">
                        <img class="rounded mx-auto d-block" style="max-height: 530px;" src="{{  asset('pictures/carousel1.jpeg')  }}" alt="Carousel slide 1">
                    </div>
                    <div class="carousel-item">
                        <img class="rounded mx-auto d-block" style="max-height:530px;" src="{{  asset('pictures/carousel2.jpeg')  }}" alt="Carousel slide 2">
                    </div>
                    <div class="carousel-item">
                        <img class="rounded mx-auto d-block" style="max-height:530px;" src="{{  asset('pictures/carousel3.jpeg')  }}" alt="Carousel slide 3">
                    </div>
                </div>

                <a class="carousel-control-prev" href="#carouselLeandingPageIndicators" role="button" data-slide="prev">
                    <span class="carousel-control-prev-icon bg-dark p-3 img-thumbnail border border-dark" aria-hidden="true"></span>
                    <span class="sr-only">Previous</span>
                </a>
                <a class="carousel-control-next" href="#carouselLeandingPageIndicators" role="button" data-slide="next">
                    <span class="carousel-control-next-icon bg-dark p-3 img-thumbnail border border-dark" aria-hidden="true"></span>
