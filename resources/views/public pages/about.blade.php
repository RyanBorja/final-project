...
@section('content')
        ...
        @component('layouts.card')
            ...
            @slot('cardBody')
                ...
                <p class="card-text p-3 mx-auto" style="width: 70%;">Today, we are growing and expanding over the entire state of Kentucky. With Viktor and Alex's reputation for craftmandship and service word has spread quickly. We aquire most of our business from word of mouth and referrals in the industry.</p>
            @endslot
            @slot('cardImg')
